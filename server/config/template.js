...
exports.developerSignup = (host, { resetToken, email }) => {
  const message = {
    subject: 'Developer Registration',
    text: `${
      'Congratulations! Your application has been accepted. Please complete your Developer account signup by clicking on the link below. \n\n' +
      'Please click on the following link, or paste this into your browser to complete the process:\n\n' +
      'http://'
    }${host}/developer-signup/${resetToken}?email=${email}\n\n`
  };

  return message;
};

exports.developerWelcome = name => {
  const message = {
    subject: 'Developer Registration',
    text:
      `Hi ${name}! Congratulations! Your application for developer account has been accepted. \n\n` +
      `It looks like you already have a member account with us. Please sign in with your member credentials and you will be able to see your developer account.`
  };
...
exports.developerApplicationEmail = () => {
  const message = {
...
exports.developerDeactivateAccount = () => {
  const message = {
    subject: 'Developer account on Template Store',
    text:
      `Your developer account has been disabled. \n\n` +
